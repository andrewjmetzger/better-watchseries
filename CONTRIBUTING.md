...
*   [**General discussion**](https://gitter.im/better-watchseries/Lobby)
...
*   Search the issue tracker (including closed issues) before opening a new
    issue
*   Ensure you’re using the latest version of the project before you submit an issue
*   Use a clear and descriptive title
*   Follow the issue templates
*   Include as much information as possible: steps to reproduce the issue,
    error message, project version, operating system, etcetera
